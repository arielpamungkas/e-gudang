          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url('admin/form_barangmasuk') ?>"><i class="fa fa-circle-o"></i> Tambah Data Barang
                  Masuk</a></li>
              <li class="active"><a href="<?= base_url('admin/form_satuan') ?>"><i class="fa fa-circle-o"></i> Tambah
                  Satuan Barang</a></li>
            </ul>
          </li>
          <li class="treeview ">
                  ...
                  <form action="<?= base_url('admin/proses_satuan_insert') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group" style="display:inline-block;">
                        ...
                        <input type="text" name="kode_satuan" style="width: 90%;margin-right: 67px;margin-left: 11px;"
                          class="form-control" id="kode_satuan" placeholder="Kode Satuan">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_satuan" style="width:73%;">Nama Satuan</label>
                        <input type="text" name="nama_satuan" style="width:90%;margin-right: 67px;" class="form-control"
