...
<head>
  ...
  <title>E-Gudang | Satuan Barang</title>
                  ...
                  <form action="<?= base_url('admin/proses_tambah_user') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group" style="display:block;">
                        ...
                        <input type="text" name="username" style="width: 30%;margin-right: 67px;margin-left: 0px;"
                          class="form-control" id="username" placeholder="Username">
                      </div>
                      <div class="form-group" style="display:block;">
                        <label for="email" style="width:73%;">Email</label>
                        <input type="text" name="email" style="width:30%;margin-right: 67px;" class="form-control"
                          id="email" placeholder="Email">
                      </div>
                      <div class="form-group" style="display:block;">
                        <label for="password" style="width:73%;">Password</label>
                        <input type="password" name="password" style="width:30%;margin-right: 67px;"
                          class="form-control" id="password" placeholder="Password">
                      </div>
                      <div class="form-group" style="display:block;">
                        <label for="confirm_password" style="width:73%;">Confirm Password</label>
                        <input type="password" name="confirm_password" style="width:30%;margin-right: 67px;"
                      ...
                      <div class="box-footer" style="width:93%;">
                        ...
                        <a type="button" class="btn btn-info" style="width:13%;margin-right:29%"
