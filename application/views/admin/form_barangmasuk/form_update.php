                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <?php foreach ($data_barang_update as $d) { ?>
                          ...
                          <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;"
                        ...
                        <div class="form-group" style="display:inline-block;">
                          ...
                          <input type="text" name="nama_barang" required style="width:90%;margin-right: 67px;"
                        ...
                        <div class="form-group" style="display:inline-block;">
                          ...
                          <input type="number" name="jumlah" style="width:41%;margin-left:34px;margin-right:18px;"
                            class="form-control" id="jumlah" value="<?= $d->jumlah ?>">
                        </div>
                      <?php } ?>
                      <!-- /.box-body -->
