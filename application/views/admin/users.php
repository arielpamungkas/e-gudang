                    ...
                    <tr>
                      <?php if (is_array($list_users)) { ?>
                        <?php foreach ($list_users as $dd): ?>
                          ...
                          <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_user/' . $dd->id) ?>"
                              name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                          </td>
